...
class UserModelTestCase(TestCase):
    ...
    def test_first_name_can_contain_50_characters(self):
    ...
    def test_last_name_can_contain_50_characters(self):
    ...
    def test_email_name_cannot_be_blank(self):
        self.user.email = ''
        self._assert_user_is_invalid()
    ...
    def test_bio_can_contain_520_characters(self):
        self.user.bio = 'x'*520
        self._assert_user_is_valid()

    def test_bio_cannot_contain_above_520_characters(self):
        self.user.bio = 'x'*521
        self._assert_user_is_invalid()
